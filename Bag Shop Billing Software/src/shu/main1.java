...
public class main1 extends javax.swing.JFrame {
    ...
    */
    ...
    jButton10.setText("display employee");
    ...
    jButton11.setText("clear employee");
...
// TODO add your handling code here:
        ...
        try{
            ...
            ps.setString(7,date);
            ps.executeUpdate();
            JOptionPane.showMessageDialog(null,"add empolyee succesfully");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            ResultSet rs;
               ...
               int a=Integer.parseInt(t1.getText());
                rs=ps.executeQuery("select * from emp where emp_id ="+a+"");
        ...
        }catch(Exception e){JOptionPane.showMessageDialog(null,"Emp_id is requrid");}
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            String date;
            date = sdf.format(t7.getDate());
            PreparedStatement p=co.prepareStatement("update emp set Name='"+s2+"',Mail='"+s3+"',Address='"+s4+"',city='"+s5+"',m_no='"+s6+"',date='"+date+"' where emp_id='"+a+"' ");
            p.executeUpdate(); 
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try{
            ...
            PreparedStatement ps=co.prepareStatement("delete from emp where emp_id="+(Integer.parseInt(t1.getText())));
            ps.executeUpdate();
 ...
 while(model.getRowCount()>0)
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        try
        {
            ...
            Class.forName("com.mysql.jdbc.Driver");
            Connection co=DriverManager.getConnection("jdbc:mysql://localhost:3306/project","root","root");
            PreparedStatement ps=co.prepareStatement("delete  from emp ");
